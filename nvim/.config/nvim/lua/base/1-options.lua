...
vim.opt.colorcolumn = "180" -- PEP8 like character limit vertical bar.
...
vim.opt.scrolloff = 7 -- Number of lines to leave before/after the cursor when scrolling. Setting a high value keep the cursor centered.
...
if is_android then vim.opt.mouse = "v" else vim.opt.mouse = "" end -- Enable scroll for android
